...
class ReportPDF(FPDF):
    ...
    def footer(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 5, "Skill created by Behram Shukur", 0, 0, "L", link="https://www.linkedin.com/in/behram-shukur-1440a732b/")
            self.set_text_color(*C_MUTED)
            self.cell(0, 5, "Want a custom build? DM me on LinkedIn", 0, 0, "R", link="https://www.linkedin.com/in/behram-shukur-1440a732b/")
