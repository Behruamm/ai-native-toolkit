...
description: Analyze LinkedIn profiles and deconstruct single posts for content strategy insights
user-invocable: true
...
1. **Check Requirements**: Ensure `linkedin-analyzer` is installed (`which linkedin-analyzer`). If not, ask the user to `pip install ai-native-toolkit`.
